...
export const SUPA_URL =
  process.env.NEXT_PUBLIC_SUPABASE_URL || publicConfig.supabaseUrl;

// Public application configuration, never a service-role/secret key.
// Bundled fallback makes a fresh browser work even without deployment env overrides.
export function getKey() {
  return process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY ||
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || publicConfig.supabasePublishableKey;
}
...
export const TIER = {
  ...
  A: { label: 'A', color: 'var(--warn)', text: 'var(--bg)',  note: 'High return.' },
  B: { label: 'B', color: 'var(--info)', text: 'var(--bg)', note: 'Worth doing.' },
...
export const BUILD = 'v2.7 · day navigation & photos';
